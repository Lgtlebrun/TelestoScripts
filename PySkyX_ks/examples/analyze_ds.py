...
outFile.write("Discoverer, WDS, Components, MP. Obs. Date(UT), P-RA (j2k), P-Dec (j2k), S-RA (j2k), S-Dec (j2k), Catalog PA, Catalog Separation, Image PA, Image Separation, Rel. Sep. Dist. \n")
