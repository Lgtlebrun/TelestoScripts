...
//
// Fixed an it/than/else bug that caused exposures to be ignored.
//
// Ken Sturrock
// January 05, 2018
//
...
//
{
	if ( filName == "Red" )
	{
		ccdsoftCamera.setPropDbl("m_daf2CalibrationExposureTime", "0.75" );
	} 

	if ( filName == "Green" )
	{
		ccdsoftCamera.setPropDbl("m_daf2CalibrationExposureTime", "0.7" );

	} 

	if ( filName == "Blue" )
	{
		ccdsoftCamera.setPropDbl("m_daf2CalibrationExposureTime", "0.8");
	} 


	if ( filName == "Ha" )
	{
		ccdsoftCamera.setPropDbl("m_daf2CalibrationExposureTime", "7");
	} 
	...
	if ( filName == "Clear" )
	{
		...
		ccdsoftCamera.setPropDbl("m_daf2CalibrationExposureTime", "0.4");
